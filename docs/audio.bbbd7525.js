...
module.exports = require("25329c0fc0d22c65").getBundleURL("7ChWY") + "background.527e578f.jpg" + "?" + Date.now();

},{"25329c0fc0d22c65":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
module.exports = require("b157c04c9e58acf3").getBundleURL("7ChWY") + "Character.80b62d66.png" + "?" + Date.now();

},{"b157c04c9e58acf3":"lgJ39"}],"3npH8":[function(require,module,exports) {
module.exports = require("707cc77f0cd27e18").getBundleURL("7ChWY") + "Platform.c1c42828.jpg" + "?" + Date.now();

},{"707cc77f0cd27e18":"lgJ39"}],"2e6o8":[function(require,module,exports) {
module.exports = require("288342afc679241d").getBundleURL("7ChWY") + "block.5ab50184.jpg" + "?" + Date.now();

},{"288342afc679241d":"lgJ39"}],"euq6J":[function(require,module,exports) {
module.exports = require("525bc10d187321d7").getBundleURL("7ChWY") + "background_music.74f76bc7.wav" + "?" + Date.now();

},{"525bc10d187321d7":"lgJ39"}],"3GTnn":[function(require,module,exports) {
// Import PIXI
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
module.exports = require("788b5cfd8af709f8").getBundleURL("7ChWY") + "walk_sound.f00aacbc.wav" + "?" + Date.now();

},{"788b5cfd8af709f8":"lgJ39"}],"6iCic":[function(require,module,exports) {
module.exports = require("f211f1371c27a024").getBundleURL("7ChWY") + "jump_sound.ba9f794f.wav" + "?" + Date.now();

},{"f211f1371c27a024":"lgJ39"}],"ZkQOi":[function(require,module,exports) {
module.exports = require("83744bd5eed40c36").getBundleURL("7ChWY") + "injury_sound.b31157d0.wav" + "?" + Date.now();

},{"83744bd5eed40c36":"lgJ39"}],"fNYDy":[function(require,module,exports) {
module.exports = require("b62ac09721eeb4f1").getBundleURL("7ChWY") + "fall_sound.518f0ac1.wav" + "?" + Date.now();

},{"b62ac09721eeb4f1":"lgJ39"}],"bSsbt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
