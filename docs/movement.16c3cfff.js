...
module.exports = require("8cc57f6eb744dce8").getBundleURL("ltmzy") + "background.527e578f.jpg" + "?" + Date.now();

},{"8cc57f6eb744dce8":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
module.exports = require("174df28d1a7e3be6").getBundleURL("ltmzy") + "Character.80b62d66.png" + "?" + Date.now();

},{"174df28d1a7e3be6":"lgJ39"}],"5wAU5":[function(require,module,exports) {
module.exports = require("895f8724b39e020c").getBundleURL("ltmzy") + "Platform.c1c42828.jpg" + "?" + Date.now();

},{"895f8724b39e020c":"lgJ39"}],"eYpjS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
